                                ...
                                <div className="col-6">
                                    <div className="product product-2">
                                        ...
                                        <div className="product-body">
                                            ...
                                            <h3 className="product-title"><a href="product.html">Canon - EOS 5D Mark IV DSLR  Camera</a></h3>
                                            <div className="product-price">
                                ...
                                <div className="col-6">
                                    <div className="product product-2">
                                        ...
                                        <div className="product-body">
                                            ...
                                            <h3 className="product-title"><a href="product.html">Apple - Smart Keyboard Folio  for 11-inch iPad Pro</a></h3>
                                            <div className="product-price">
